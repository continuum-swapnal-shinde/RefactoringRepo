...
public class AgentServiceStep extends GlobalVariables {
	...
	@Then("^I fetch and validate asset plugin json for log level changes as \"([^\"]*)\"$")
	...
	@Given("^I install exe to install MSI Package through command prompt$")
	...
	@And("^I uninstall MSI Package through command prompt$")
	...
	public void i_send_a_agent_configuration_change_Post_request_with_header_endpoint_as(String endpoint,
		...
		try {
			pluginHelper.agentConfigurationChangePostRequestWithHeaderAndEndpoint(endpoint, hashcode);
		} catch (Exception e) {
			ErrorReporter.reportError(e);
		}
	}
	...
	public void i_validate_the_response_with_actual_endpoint_details() throws Throwable {
		try {
			pluginHelper.validateResponseWithActualEndpointDetails();
		} catch (Exception e) {
			ErrorReporter.reportError(e);
		}
	}
	...
	public void i_send_a_POST_request_to_update_mapping_API_endpoint_as(String endpoint) throws Throwable {
		try {
			pluginHelper.sendPOSTrequestToUpdateMappingAPIendpoint(endpoint);
		} catch (Exception e) {
			ErrorReporter.reportError(e);
		}
	}
	...
	public void i_send_a_invalid_data_to_update_mapping_POST_API_endpoint_as(String endpoint) throws Throwable {
		try {
			pluginHelper.sendInvalidDataToUpdateMappingPOSTapi(endpoint);
		} catch (Exception e) {
			ErrorReporter.reportError(e);
		}
	}
