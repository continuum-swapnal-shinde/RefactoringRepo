...
public class FrameworkServices {
	...
	public Ssh sshManager(String hostName,JunoPageFactory sshObj){
		...
		else if(hostName.equalsIgnoreCase("WinServer3R2_64Bit"))
		{
			if(sshObj.WinServer3R2_64Bit==null ||  !(sshObj.WinServer3R2_64Bit.getS().isConnected())) {
			sshObj.WinServer3R2_64Bit = Ssh.CreateSession(Utilities.getMavenProperties("UserNameWinServer3R2_64Bit"),
					Utilities.getMavenProperties("WinServer3R2_64Bit"), Utilities.getMavenProperties("DefaultPort"),
					Utilities.getMavenProperties("PasswordWinServer3R2_64Bit"));
			}
			sshObj.gSSHSessionObj = sshObj.WinServer3_64Bit;
		}
	...
	public String fetchEndpointID(String ostype,JunoPageFactory sshObj){
		...
		{
			endPointID = sshObj.gSSHSessionObj.SshCommandExecution("LinuxEndpointID", Ssh.ReadCSVCommand("GetEndPointID"));
		}
