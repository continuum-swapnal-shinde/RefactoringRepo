...
public class GlobalVariables extends JunoPageFactory{
	...
	public static String tk, messageID, processID,processID1, response, scheduleJson, configJson, endPointID, endPointID1, endPointID12,
			...
			memory, motherBoardAdapterSrNo, cdromSerial, osSerialNumber, systemManufacturer, uuid,globalManifestJson,CheckSumValue;
	...
	public static String packageToFeatureJson;
	public static JSONObject newProductJson;
