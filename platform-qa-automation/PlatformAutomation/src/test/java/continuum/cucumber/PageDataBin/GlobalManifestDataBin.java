...
public class GlobalManifestDataBin {
	 ...
	 private EnabledPartnersManifest enabledPartnersManifest;
	...
	public EnabledPartnersManifest getEnabledPartnersManifest() {
		return enabledPartnersManifest;
	}

	public void setEnabledPartnersManifest(EnabledPartnersManifest partnerDetails) {
		this.enabledPartnersManifest = partnerDetails;
	}
